---
id: wait-time-questioning-protocol
title: "The Wait-Time Questioning Protocol: Rowe's Twin Pauses, Cognitive Latency, and Dylan Wiliam Formative Calibration"
type: intervention
...
![KMOFAP 3-5 Second Wait-Time Chronometer](../../assets/kmofap_wait_time_chronometer_1789443291874.jpg)
...
```mermaid
graph TD
    TeacherQuestion["Teacher Poses High-Order Question"] --> WaitTime1["WAIT-TIME 1: 3 to 5 Seconds (Total Silence)"]
    WaitTime1 --> StudentCognition["Students search long-term memory, parse syntax, evaluate hypotheses"]
    StudentCognition --> StudentResponse["Student Provides Initial Answer"]
    StudentResponse --> WaitTime2["WAIT-TIME 2: 3 to 5 Seconds (Teacher Pauses Before Speaking)"]
    WaitTime2 --> StudentElaboration["Student Self-Corrects, Adds Evidence, or Peers Chime In"]
    StudentElaboration --> FormativeUptake["Teacher Uptake: 'What evidence supports Marcus's point?'"]
```
